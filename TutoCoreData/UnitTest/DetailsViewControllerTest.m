...
#import "DetailsViewControllerTest.h"
...
- (void)tearDown
{
    ...
    _mDetailsViewController = nil;
    _mImageView             = nil;
    [super tearDown];
}

- (void)test_DetailsViewControllerTest_DetailsViewController_NotNil
{
...
- (void)test_DetailsViewControllerTest_DetailsViewController_Class
{
...
- (void)test_DetailsViewControllerTest_ImageView_NotNil
{
    STAssertNotNil(_mImageView, @"ImageView IBOutlet not connected");
    [_mNavigationController popToRootViewControllerAnimated:FALSE]; // Retour au rootViewController
}

- (void)test_DetailsViewControllerTest_ImageView_Class
{
